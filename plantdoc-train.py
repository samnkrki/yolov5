...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/plantdoc.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--cache', type=str, nargs='?', const='disk', default='disk', help='--cache images in "ram" (default) or "disk"')
    ...
    parser.add_argument('--name', default='plantdoc', help='save to project/name')
