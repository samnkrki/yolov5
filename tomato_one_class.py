...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    v = save_dir / 'validations' # validations dir
    ...
    if RANK in {-1, 0}:
        ...
        if not resume:
            ...
            if plots:
                ...
                plot_labels(val_labels, names, save_dir=Path.joinpath(save_dir, "validations") )
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/tomato_one.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=1280, help='train, val image size (pixels)')# can be 1920
    ...
    parser.add_argument('--cache', type=str, nargs='?', default='disk', const='ram', help='--cache images in "ram" (default) or "disk"')
    ...
    parser.add_argument('--name', default='tomato-one', help='save to project/name')
