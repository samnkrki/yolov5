...
def parse_opt(known=False):
    ...
    parser.add_argument('--name', default='my-capsicum', help='save to project/name')
    ...
    parser.add_argument('--include-class', type=list, default=[0,1,8,10,11,13,15,17], help='Add only those classes that you need on detection')
    parser.add_argument('--selective-augmentation', type=bool, default=False, help='To augment only classes with less data')
