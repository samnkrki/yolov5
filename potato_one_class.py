...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/potato_one.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=1024, help='train, val image size (pixels)')# can be 1920
    ...
    parser.add_argument('--name', default='potato-one', help='save to project/name')
